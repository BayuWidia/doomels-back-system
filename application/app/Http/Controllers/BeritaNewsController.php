...
class BeritaNewsController extends Controller
{
  public function lihat()
  {
    ...
    return view('backend/pages/lihatnews')->with('getberita', $getberita);
  }

  public function tambah()
  {
    // if (Auth::user()->level=="1") {
    //   $getkategori = KategoriBerita::where([['id_skpd', null], ['flag_utama', 2]])->paginate(10);
    // } else {
    //   $getkategori = KategoriBerita::where([['id_skpd', Auth::user()->masterskpd->id], ['flag_utama', 0]])->paginate(10);
    // }
     $getkategori = KategoriBerita::where('flag_utama', 2)->get();

    return view('backend/pages/tambahnews')->with('getkategori', $getkategori);
  }
  ...
  public function store(Request $request)
  {
    ...
    if ($file!=null) {
      ...
      // Image::make($file)->fit(256,173)->save('images/'. $photo256);
        ...
        $set->isi_dumel = $request->isi_dumel;
        $set->save();
    } else {
        $set = new Berita;
        $set->id_kategori = $request->id_kategori;
    ...
    return redirect()->route('news.tambah')->with('message', 'Berhasil menambahkan konten berita baru.');
  }
  ...
  public function edit($id)
  {
    ...
    return view('backend/pages/tambahnews')
  ...
  public function update(Request $request)
  {
    ...
    return redirect()->route('news.tambah')->with('message', 'Berhasil mengubah konten berita.');
  }
  ...
  public function flagpublish($id)
  {
    ...
    return redirect()->route('news.lihat')->with('message', 'Berhasil mengubah status publikasi berita.');
  }
  ...
  public function delete($id)
  {
    ...
    return redirect()->route('news.lihat')->with('message', 'Berhasil menghapus konten berita.');
  }
