...
class BeritaTravellerController extends Controller
{
  public function lihat()
  {
    ...
    return view('backend/pages/lihattraveller')->with('getberita', $getberita);
  }

  public function tambah()
  {
     $getkategori = KategoriBerita::where('flag_utama', 3)->get();

    return view('backend/pages/tambahtraveller')->with('getkategori', $getkategori);
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('traveller.tambah')->with('message', 'Berhasil menambahkan konten berita baru.');
  }
  ...
  public function edit($id)
  {
    ...
    return view('backend/pages/tambahtraveller')
  ...
  public function update(Request $request)
  {
    ...
    return redirect()->route('traveller.tambah')->with('message', 'Berhasil mengubah konten berita.');
  }
  ...
  public function flagpublish($id)
  {
    ...
    return redirect()->route('traveller.lihat')->with('message', 'Berhasil mengubah status publikasi berita.');
  }
  ...
  public function delete($id)
  {
    ...
    return redirect()->route('traveller.lihat')->with('message', 'Berhasil menghapus konten berita.');
  }
