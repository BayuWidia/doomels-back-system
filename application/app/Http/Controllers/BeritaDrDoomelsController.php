...
class BeritaDrDoomelsController extends Controller
{
  public function lihat()
  {
    ...
    return view('backend/pages/lihatdrdoomels')->with('getberita', $getberita);
  }
  ...
  public function tambah()
  {
    ...
    // }
     $getkategori = KategoriBerita::where('flag_utama', 1)->get();

    return view('backend/pages/tambahdrdoomels')->with('getkategori', $getkategori);
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('drdoomels.tambah')->with('message', 'Berhasil menambahkan konten berita baru.');
  }
  ...
  public function edit($id)
  {
    ...
    return view('backend/pages/tambahdrdoomels')
  ...
  public function update(Request $request)
  {
    ...
    return redirect()->route('drdoomels.tambah')->with('message', 'Berhasil mengubah konten berita.');
  }
  ...
  public function flagpublish($id)
  {
    ...
    return redirect()->route('drdoomels.lihat')->with('message', 'Berhasil mengubah status publikasi berita.');
  }
  ...
  public function delete($id)
  {
    ...
    return redirect()->route('drdoomels.lihat')->with('message', 'Berhasil menghapus konten berita.');
  }
