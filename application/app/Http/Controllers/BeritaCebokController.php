...
class BeritaCebokController extends Controller
{
  public function lihat()
  {
    ...
    return view('backend/pages/lihatcebok')->with('getberita', $getberita);
  }

  public function tambah()
  {
     $getkategori = KategoriBerita::where('flag_utama', 5)->get();

    return view('backend/pages/tambahcebok')->with('getkategori', $getkategori);
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('cebok.tambah')->with('message', 'Berhasil menambahkan konten berita baru.');
  }
  ...
  public function edit($id)
  {
    ...
    return view('backend/pages/tambahcebok')
  ...
  public function update(Request $request)
  {
    ...
    return redirect()->route('cebok.tambah')->with('message', 'Berhasil mengubah konten berita.');
  }
  ...
  public function flagpublish($id)
  {
    ...
    return redirect()->route('cebok.lihat')->with('message', 'Berhasil mengubah status publikasi berita.');
  }
  ...
  public function delete($id)
  {
    ...
    return redirect()->route('cebok.lihat')->with('message', 'Berhasil menghapus konten berita.');
  }
