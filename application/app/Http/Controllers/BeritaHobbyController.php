...
class BeritaHobbyController extends Controller
{
  public function lihat()
  {
    ...
    return view('backend/pages/lihathobby')->with('getberita', $getberita);
  }

  public function tambah()
  {
     $getkategori = KategoriBerita::where('flag_utama', 4)->get();

    return view('backend/pages/tambahhobby')->with('getkategori', $getkategori);
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->route('hobby.tambah')->with('message', 'Berhasil menambahkan konten berita baru.');
  }
  ...
  public function edit($id)
  {
    ...
    return view('backend/pages/tambahhobby')
  ...
  public function update(Request $request)
  {
    ...
    return redirect()->route('hobby.tambah')->with('message', 'Berhasil mengubah konten berita.');
  }
  ...
  public function flagpublish($id)
  {
    ...
    return redirect()->route('hobby.lihat')->with('message', 'Berhasil mengubah status publikasi berita.');
  }
