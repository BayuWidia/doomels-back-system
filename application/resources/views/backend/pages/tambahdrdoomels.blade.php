  ...
  <div class="row">
    ...
    <div class="col-md-12">
      <form class="form-horizontal"
        @if(isset($editberita))
          action="{{route('drdoomels.update')}}"
        @else
          action="{{route('drdoomels.store')}}"
        @endif
      method="post" style="margin-top:10px;" enctype="multipart/form-data">
        ...
        <div class="box box-danger">
          ...
          <div class="box-body">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Isi Dumelan</label>
                <div class="col-sm-9">
                  <textarea required="true" class="textarea" name="isi_dumel" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">
                   @if(isset($editberita))
                      {{$editberita->isi_dumel}}
                    @endif
                  </textarea>
                </div>
              </div>
