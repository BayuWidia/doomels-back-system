  ...
  <div class="modal fade" id="modaldelete" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Hapus Hobby</h4>
        </div>
        <div class="modal-body">
    ...
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <a href="{{route('hobby.tambah')}}" class="btn bg-navy btn-flat margin">Tambah Berita</a>
        </div><!-- /.box-header -->
        <div class="box-body">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @if(Auth::user()->level!="1")
                      ...
                      @else
                        <span data-toggle="tooltip" title="Edit">
                          <a href="{{route('hobby.edit', $key->id_berita)}}" class="btn btn-xs btn-warning btn-flat"><i class="fa fa-edit"></i></a>
                        </span>
                    ...
                    <span data-toggle="tooltip" title="Lihat Konten">
                      <a href="{{route('hobby.preview', $key->id_berita)}}" class="btn btn-xs btn-primary btn-flat"><i class="fa fa-eye"></i></a>
                    </span>
                  </td>
                </tr>
                <?php $i++; ?>
  ...
  <script>
    $(function () {
      ...
      $("#tabelinfo").on("click", "a.flagpublish", function(){
        ...
        $('#setflagpublish').attr('href', '{{url('admin/publish-hobby/')}}/'+a);
      });

      $("#tabelinfo").on("click", "a.hapus", function(){
        var a = $(this).data('value');
        $('#sethapus').attr('href', '{{url('admin/delete-hobby/')}}/'+a);
      });
    });
  </script>
