...
@section('breadcrumb')
  <h1>
    Management Dr. Doomels
    <small>Kategori Dr. Doomels</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Kategori Dr. Doomels</li>
  </ol>
@stop
...
@section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Hapus Data Kategori Dr. Doomels</h4>
        </div>
  ...
  <div class="modal fade" id="modalflagedit" role="dialog">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title">Edit Status Kategori Dr. Doomels</h4>
        </div>
        <div class="modal-body">
  ...
  <div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog">
      <form class="form-horizontal" action="{{route('drdoomels.kategori.edit')}}" method="post">
        {{ csrf_field() }}
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Edit Kategori Dr. Doomels</h4>
          </div>
          <div class="modal-body">
            <div class="col-md-14 ">
  ...
  <div class="row">
    ...
    <form class="form-horizontal" action="{{route('drdoomels.kategori.store')}}" method="post">
      {{ csrf_field() }}
      <div class="col-md-4">
    ...
    <div class="col-md-8">
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">List Data Kategori Dr. Doomels</h3>
        </div>
  ...
  <script type="text/javascript">
    $(function(){
      $('a.flagedit').click(function(){
        ...
        $('#setflagedit').attr('href', '{{url('admin/change-status-kategori-drdoomels/')}}/'+a);
      });

      $('a.hapus').click(function(){
        var a = $(this).data('value');
        $('#sethapus').attr('href', '{{url('admin/delete-kategori-drdoomels//')}}/'+a);
      });

      $('a.edit').click(function(){
        var a = $(this).data('value');
        $.ajax({
          url: "{{url('/')}}/admin/bind-kategori-drdoomels/"+a,
          dataType: 'json',
