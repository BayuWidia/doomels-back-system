...
@section('breadcrumb')
  <h1>
    Management News
    <small>Kategori News</small>
  </h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> Dashboard</a></li>
    <li class="active">Kategori News</li>
  </ol>
@stop
...
@section('content')
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Hapus Data Kategori News</h4>
        </div>
  ...
  <div class="modal fade" id="modaledit" role="dialog">
    <div class="modal-dialog">
      <form class="form-horizontal" action="{{route('news.kategori.edit')}}" method="post">
        {{ csrf_field() }}
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title">Edit Kategori News</h4>
          </div>
          <div class="modal-body">
            <div class="col-md-14 ">
  ...
  <div class="row">
    ...
    <form class="form-horizontal" action="{{route('news.kategori.store')}}" method="post">
      {{ csrf_field() }}
      <div class="col-md-4">
    ...
    <div class="col-md-8">
      <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title">List Data Kategori News</h3>
        </div>
  ...
  <script type="text/javascript">
    $(function(){
      $('a.flagedit').click(function(){
        ...
        $('#setflagedit').attr('href', '{{url('admin/change-status-kategori-news/')}}/'+a);
      });

      $('a.hapus').click(function(){
        var a = $(this).data('value');
        $('#sethapus').attr('href', '{{url('admin/delete-kategori-news//')}}/'+a);
      });

      $('a.edit').click(function(){
        var a = $(this).data('value');
        $.ajax({
          url: "{{url('/')}}/admin/bind-kategori-news/"+a,
          dataType: 'json',
