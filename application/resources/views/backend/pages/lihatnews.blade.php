    ...
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <a href="{{route('news.tambah')}}" class="btn bg-blue btn-flat margin">Tambah Berita</a>
        </div><!-- /.box-header -->
        <div class="box-body">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    @if(Auth::user()->level!="1")
                      ...
                      @else
                        <span data-toggle="tooltip" title="Edit">
                          <a href="{{route('news.edit', $key->id_berita)}}" class="btn btn-xs btn-warning btn-flat"><i class="fa fa-edit"></i></a>
                        </span>
                    ...
                    <span data-toggle="tooltip" title="Lihat Konten">
                      <a href="{{route('news.preview', $key->id_berita)}}" class="btn btn-xs btn-primary btn-flat"><i class="fa fa-eye"></i></a>
                    </span>
                  </td>
                </tr>
                <?php $i++; ?>
  ...
  <script>
    $(function () {
      ...
      $("#tabelinfo").on("click", "a.flagpublish", function(){
        ...
        $('#setflagpublish').attr('href', '{{url('admin/publish-news/')}}/'+a);
      });

      $("#tabelinfo").on("click", "a.hapus", function(){
        var a = $(this).data('value');
        $('#sethapus').attr('href', '{{url('admin/delete-news/')}}/'+a);
      });
    });
  </script>
